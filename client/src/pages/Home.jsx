      ...
      <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <Link
              className="block w-full rounded border border-zinc-600 px-12 py-3 text-sm font-medium text-zinc-600 hover:bg-zinc-600 hover:text-white focus:outline-none focus:ring active:bg-zinc-500 sm:w-auto"
              to="https://github.com/MuhammadUmar7831/expense-tracker"
              target="_blank"
            >
              Learn More
            </Link>
